...
const handbookSections = [
    ...
    },
    {
        ...
        chapters: [
            ...
            {
                id: "ch20",
                title: "Assembly, Packaging & Test (Overview)",
                order: 7,
            },
        ],
    },
    {
        ...
        chapters: [
            ...
            {
                id: "ch23",
                title: "Advanced Packaging & Heterogeneous Integration",
                order: 3,
            },
            {
                id: "ch24",
                title: "Compound Semiconductors & Advanced Materials",
                order: 4,
            },
            {
                id: "ch25",
                title: "Quantum Computing & Semiconductors",
                order: 5,
            },
            {
                id: "ch26",
                title: "AI/ML in Semiconductor Design & Manufacturing",
                order: 6,
            },
        ],
    },
    {
        ...
        chapters: [
            {
                id: "ch27",
                title: "Technology Roadmaps & Scaling Challenges",
                order: 1,
            },
            ...
            {
                id: "ch30",
                title: "Essential Skills for Semiconductor Professionals",
                order: 4,
            },
            {
                id: "ch31",
                title: "Educational Pathways & Continuous Learning",
                order: 5,
            },
        ],
    },
    {
        ...
        chapters: [
            ...
            {
                id: "ch34",
                title: "Online Courses & Educational Platforms",
                order: 3,
            },
        ...
        >
            <div className="sticky top-0 z-10 bg-white dark:bg-gray-950 border-b border-gray-100 dark:border-gray-800 p-4 pb-2">
                <Link href="/handbook" className="flex items-center mb-2">
                    <h1 className="text-lg font-medium text-teal-600 dark:text-teal-400">
                        Silicon Guide
                    </h1>
                </Link>
                <Button
                    variant="ghost"
                    asChild
                    className="w-full justify-start font-normal mb-1 h-9"
                >
                                    ...
                                    >
                                        <div className="relative h-24 w-full">
                                            ...
                                            <div className="absolute inset-0 flex items-center justify-center p-2">
                                                <span className="text-white text-xs font-medium text-center truncate w-full block">
                                                    {section.title}
                                                </span>
                                            </div>
                                        </div>
                                        ...
                                        {hoveredSection === section.title && (
                                            <div className="absolute inset-0 bg-black bg-opacity-70 flex flex-col items-center justify-center p-1 dark:bg-opacity-80">
                                                <span className="text-white text-xs font-medium mb-1 truncate w-full block">
                                                    {section.title}
                                                </span>
                                            ...
                                            >
                                                <div className="flex flex-col items-start w-full">
                                                    <div className="flex justify-between w-full">
                                                        <span className="text-left font-semibold truncate max-w-[130px]">
                                                            {section.title}
                                                        </span>
