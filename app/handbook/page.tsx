...
import { BookOpen, FileText, ChevronRight, Compass, Grid3X3, List, ChevronDown } from "lucide-react"
...
export default function HandbookPage() {
  ...
  const [chaptersBySection, setChaptersBySection] = useState<Record<string, any[]>>({})
  ...
  const handbookSections = [
    {
      ...
      description: "Get started with the basics of semiconductor technology and the handbook structure.",
    },
    {
      title: "I. Semiconductor Fundamentals",
      image: "/emerald-circuitry.png",
      description: "Learn about the physics, materials, and core devices that form the foundation of semiconductors.",
    },
    {
      title: "II. IC Design & EDA",
      image: "/amethyst-flow.png",
      description: "Explore the design methodologies, languages, and tools used in integrated circuit development.",
    },
    {
      title: "III. Manufacturing Processes",
      image: "/abstract-orange-cleanroom.png",
      description: "Understand the complex manufacturing techniques used to create semiconductor devices.",
    },
    {
      title: "IV. Advanced Topics & Technologies",
      image: "/crimson-circuitry.png",
      description: "Dive into cutting-edge semiconductor technologies and emerging research areas.",
    },
    {
      title: "V. Industry Trends & Careers",
      image: "/abstract-yellow-trends.png",
      description: "Explore market dynamics, career paths, and the future of the semiconductor industry.",
    },
    {
      title: "VI. Resources & Community",
      image: "/interconnected-teal.png",
      description: "Find additional learning resources, tools, and communities to support your semiconductor journey.",
    },
  ]
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      try {
        ...
        setError("Failed to load handbook data. Please try again later.")
        setLoading(false)
      }
    }, 800)
  }, [])
  ...
  if (error) {
    return <ErrorMessage title="Failed to Load Handbook" message={error} retryAction={handleRetry} />
  }
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 mb-8">
        <Card>
          ...
          <CardContent>
            ...
            <div className="space-y-2">
              ...
              {sections.length > 0 &&
                ...
                chaptersBySection[sections[0]].slice(0, 3).map((chapter) => (
          ...
          <CardFooter>
            <Button
              ...
              onClick={() => (window.location.href = "/handbook/ch1")}
            >
        ...
        <Card>
          <CardHeader className="pb-2">
            ...
            <CardDescription>Find related learning materials</CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              Our Discover tool can help you find relevant resources both within the handbook and from external sources.
            </p>
            <div className="space-y-2">
              <h3 className="text-sm font-medium">Try searching for:</h3>
          ...
          <CardFooter>
            <Button
              ...
              onClick={() => {
                ...
                const discoverButton = document.querySelector('[aria-label="Open Discover"]') as HTMLButtonElement
      ...
      <div className="mb-6 flex items-center justify-between">
        <h2 className="text-xl font-bold">Handbook Sections</h2>
            ...
            >
              <div className="relative h-48 w-full">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4">
                  <h3 className="text-white text-lg font-semibold mb-1">{section.title}</h3>
              ...
              <div className="p-4 bg-white dark:bg-gray-800 dark-mode-transition">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm text-gray-500 dark:text-gray-400">
                    {chaptersBySection[section.title]?.length || 0} chapters
                  </span>
                  <span className="text-sm font-medium text-teal-600 dark:text-teal-400">
                    {getSectionProgress(section.title)}% complete
                  </span>
                </div>
                ...
                <div className="flex justify-end">
                  ...
                  >
                    <Link href={`/handbook/${chaptersBySection[section.title]?.[0]?.id || "#"}`}>
                      Explore
          ...
          <div className="space-y-6">
            {sections.map((section) => (
              <Collapsible
                ...
                onOpenChange={() => toggleSectionExpand(section)}
                    ...
                    <CollapsibleTrigger asChild>
                      ...
                      >
                        ...
                        <div className="flex items-center">
                          ...
                          <ChevronDown
                            className={`h-5 w-5 transition-transform ${expandedSections[section] ? "rotate-180" : ""}`}
                          />
                        </div>
                      </Button>
                    </CollapsibleTrigger>
                ...
                <CollapsibleContent>
                  <div className="p-4 pt-0 bg-white dark:bg-gray-800">
                    {chaptersBySection[section] &&
                      chaptersBySection[section].map((chapter) => (
                        <div key={chapter.id} className="mt-4">
                          <div className="mb-2">
                            <Button variant="outline" asChild className="justify-start h-auto py-2 w-full">
                              <Link href={`/handbook/${chapter.id}`} className="text-left">
                          ...
                          {chapter.keyTopics && chapter.keyTopics.length > 0 && (
                            <div className="ml-4 mt-2">
                              <h4 className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Key Topics:</h4>
